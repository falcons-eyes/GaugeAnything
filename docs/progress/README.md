...
| 2026-06-13 | paper v2 재배포 + 연구 포지션 냉정 평가 | [../RESEARCH_POSITION_AND_ROADMAP.md](../RESEARCH_POSITION_AND_ROADMAP.md) | 논문 v2(owned head·conformal·dynamic) 재배포 · HF checkpoint 누락 2종 업로드 · 판정: 논문 1편 제출 가능, 모델은 pre-Anything — 벤치마크→데이터→모델 순서의 H1-H3 로드맵 |
| 2026-06-13 | GaugeBench v1.0 + P2-1b detected quad | [2026-06-13_gaugebench-v1-p2-1b.md](2026-06-13_gaugebench-v1-p2-1b.md) · [../../benchmark/README.md](../../benchmark/README.md) | 벤치마크 5트랙·21핀 release gate 공개 · SAM3 detected quad: gate 96%/IoU 0.968/edge median 1.5%(naive 10-17% 대비 ~10×) — p90 tail 14-32% 정직 병기, atom official 승격 |
| 2026-06-13 | arXiv 제출 체크리스트 | [../ARXIV_SUBMISSION_CHECKLIST.md](../ARXIV_SUBMISSION_CHECKLIST.md) | 엔도스먼트(면제 확인/엔도서 요청/워크숍 병행)·라이선스 CC BY·메타데이터 = 사용자 액션 분리 · Claude 처리분(빌드·인용·drift) 체크 |
| 2026-06-13 | Count v1 density head | [2026-06-13_count-v1-density-head.md](2026-06-13_count-v1-density-head.md) | owned density head가 zero-shot SAHI(8.9)를 MAE 7.0으로 이김(stratified) · v1.1 dense undercount −29→−19(35%↓) · counting negative→partial · bulk/dense 트레이드오프 |
| 2026-06-13 | OMEN 데모 서버 + stress 테스트 | [2026-06-13_omen-demo-stress-test.md](2026-06-13_omen-demo-stress-test.md) · [../../serve/README.md](../../serve/README.md) | RTX 5090 Docker 서빙(FastAPI, --restart) · warm 90ms·10.4 req/s·edge 안전 · 신규: rebar sparse overcount(1→10) · 학습 가중치 9종 전수 로드 검증 |
